...
class Post
{
    ...
    private function getBots()
    {
        ...
        if ($stmt = $this->db->prepare($query))
        {
            ...
            {
                array_push($responseEntry, ['name' => $row['name'], 'task' => $row['task'], 'data' => $row['data'], 'insert_time' => $row['insert_time'], 'last_update' => $row['last_update']]);
            }
